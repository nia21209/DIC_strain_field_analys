...
# -----------------------------------------------------------------------------
# Call the highly_strained_region function to filter the highly strained 
# reagion

import highly_strained_region as HeV

t = 2                               # sheet thickness
surface_correction = 1.452          # correction for curved surface and anti buckling device

strain_22_thr_lll,strain_22_a_thr,strain_22_a_av,A_HeV,Error = HeV.highly_strained_region(id_field,first_stage,last_stage,thr_1,thr_2)
print('---------------------------------------------------------')
